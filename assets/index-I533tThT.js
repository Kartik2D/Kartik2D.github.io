      ...
      <div class="info-stack">
        ${e.length||this.project.browserPlayable?r`
              <div class="badges-row">
                ${e.length?r`
                      <div class="tag-list">
                        ${e.map(e=>{const{background:t,color:i}=I(e);return r`<span
                            class="tag"
...
var A;C.styles=[p,g,i`
    ...
    `],L([c({type:Object})],C.prototype,"project",2),L([c({type:Boolean})],C.prototype,"isSelected",2),L([h()],C.prototype,"_isHovered",2),L([h()],C.prototype,"_isVisible",2),L([(A=".info-pane",(e,t,i)=>((e,t,i)=>(i.configurable=!0,i.enumerable=!0,Reflect.decorate&&"object"!=typeof t&&Object.defineProperty(e,t,i),i))(e,t,{get(){return e=this,e.renderRoot?.querySelector(A)??null;var e}}))],C.prototype,"_infoPane",2),C=L([n("media-item")],C);var O=Object.defineProperty,D=Object.getOwnPropertyDescriptor,M=(e,t,i,a)=>{for(var r,o=a>1?void 0:a?D(t,i):t,s=e.length-1;s>=0;s--)(r=e[s])&&(o=(a?r(t,i,o):r(o))||o);return a&&o&&O(t,i,o),o};let H=class extends a{constructor(){super(...arguments),this.projects=[],this._handleItemSelect=e=>{const{projectId:t}=e.detail;this.dispatchEvent(new CustomEvent("item-selected",{detail:{projectId:t},bubbles:!0}))}}render(){return 0===this.projects.length?r`
      ...
      <div class="page-content">
        <div class="page-header">
          ...
          ${this.project.tags?.length?r`
                <div class="tag-list">
                  ${this.project.tags.map(e=>{const{background:t,color:i}=I(e);return r`<span
                      class="tag"
                      style="background: ${t}; color: ${i};"
                      >${e}</span
                    >`})}
    ...
    `],W([c({type:Object})],N.prototype,"project",2),N=W([n("project-page")],N);var Y=Object.defineProperty,K=Object.getOwnPropertyDescriptor,X=(e,t,i,a)=>{for(var r,o=a>1?void 0:a?K(t,i):t,s=e.length-1;s>=0;s--)(r=e[s])&&(o=(a?r(t,i,o):r(o))||o);return a&&o&&Y(t,i,o),o};let Z=class extends a{constructor(){super(...arguments),this.tags=[]}_select(e){e===this.selectedTag&&void 0!==e||this.dispatchEvent(new CustomEvent("tag-change",{detail:{tag:e},bubbles:!0,composed:!0}))}render(){return r`
      <nav class="inner" aria-label="Filter work by tag">
        <div class="chips">
          ...
          ${this.tags.map(e=>{const{background:t,color:i}=I(e);return r`
              <button
                type="button"
...
//# sourceMappingURL=index-I533tThT.js.map
